<template>
  <div>
    <div id="co1_file" :style="{ height: height, width: width }" />

    <div id="co2_file" :style="{ height: height, width: width }" />
  </div>
</template>
...
export default {
  ...
  methods: {
    initChart() {
      console.log('this.chartfileeeeeeeee', this.chartData)
      this.chart1 = echarts.init(document.getElementById('co1_file'), 'macarons')
      this.chart2 = echarts.init(document.getElementById('co2_file'), 'macarons')
